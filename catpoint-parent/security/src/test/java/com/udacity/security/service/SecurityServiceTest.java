...
public class SecurityServiceTest {
    ...
    public void ifArmed_andSensorBecomesActivated_setAlarmStatusToPending(String armingStatusStr ) {
    ...
    public void ifArmed_andSensorBecomesActivated_setAlarmStatusToOn(String armingStatusStr) {
    ...
    public void ifAlarmPending_andAllSensorsInactive_returnNoAlarmState() {
    ...
    public void ifAlarmActive_changeSensorState_AlarmStateNoChange(boolean active) {
    ...
    public void ifSensorActivatedWhileAlreadyActive_andSystemInPendingState_changeSystemStateToAlarm() {
    ...
    public void ifSensorDeactivated_whileAlreadyActive_alarmStateNoChange() {
    ...
    public void ifCatInImage_whileSystemArmedHome_putSystemIntoAlarm() {
    ...
    public void ifNoCatInImage_andSensorsNotActive_changeStatusToNoAlarm() {
    ...
    public void ifSystemArmed_resetAllSensorsToInactive(String armingStatusStr) {
    ...
    public void ifSystemArmedHome_andCatInCamera_setAlarmStatusToAlarm(String armingStatus) {
